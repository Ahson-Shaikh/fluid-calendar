# container-startup Specification

## Purpose

Require successful database preparation with bundled Prisma tooling before a self-hosted container starts the application.
